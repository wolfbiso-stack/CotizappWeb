...
const PhoneServiceReport = ({ service, user, company: companyProp, onClose, darkMode }) => {
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b-2 border-indigo-100 pb-2">Detalles del Equipo</h3>
                                      <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                              ...
                                              <strong className="text-gray-900">Celular / Smartphone</strong>
                                          </div>
                                          <div>
                                          ...
                                          <div>
                                              <span className="text-sm text-gray-500 block">IMEI</span>
                                              <strong className="text-gray-900">{service.equipo_imei || 'N/A'}</strong>
                                          </div>
                                          <div>
                                              <span className="text-sm text-gray-500 block">Contraseña/PIN</span>
                                              <strong className="text-gray-900 font-mono tracking-wider bg-yellow-100 px-2 py-0.5 rounded">{service.equipo_pass || 'N/A'}</strong>
                                          </div>
...
export default PhoneServiceReport;

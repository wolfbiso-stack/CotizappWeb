...
const PrinterServiceReport = ({ service, user, company: companyProp, onClose, darkMode }) => {
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b-2 border-indigo-100 pb-2">Detalles del Equipo</h3>
                                      <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                              ...
                                              <strong className="text-gray-900">Impresora</strong>
                                          </div>
                                          <div>
                                              <span className="text-sm text-gray-500 block">Marca y Modelo</span>
                                              <strong className="text-gray-900">{service.modelo || service.equipo_modelo || 'N/A'}</strong>
                                          </div>
                                          <div>
                                              <span className="text-sm text-gray-500 block">Número de Serie</span>
                                              <strong className="text-gray-900">{service.num_serie || service.equipo_serie || 'N/A'}</strong>
                                          </div>
                                          <div>
                                              <span className="text-sm text-gray-500 block">Contador de Páginas</span>
                                              <strong className="text-gray-900">{service.contador_paginas || 'N/A'}</strong>
                                          </div>
                                          <div>
                                              <span className="text-sm text-gray-500 block">Niveles de Tinta</span>
                                              <strong className="text-gray-900">{service.niveles_tinta || 'N/A'}</strong>
                                          </div>
...
export default PrinterServiceReport;

                ...
                <form id="cctvForm" onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-4 md:px-8 py-6 space-y-8">
                    ...
                    <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6">
                                    ...
                                    <ClientAutocomplete
                                        ...
                                        onSelect={(client) => {
                                            setFormData(prev => ({
                                                ...
                                                cliente_direccion: client.empresa || client.notas || prev.cliente_direccion
                                            }));
                                            setIsDirty(true);
                                        }}
                                        darkMode={darkMode}
                        ...
                        <div className="col-span-3">
                            ...
                            />
                            <label className={`flex items-center gap-2 cursor-pointer mt-3 text-sm font-medium ${darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
                                <input 
                                    type="checkbox" 

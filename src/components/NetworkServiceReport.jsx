...
const NetworkServiceReport = ({ service, user, company: companyProp, onClose, darkMode }) => {
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b-2 border-indigo-100 pb-2">Detalles del Equipo</h3>
                                      <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-2 md:grid-cols-3 gap-4">
                                          <div>
                                              ...
                                              <strong className="text-gray-900">{service.tipo_servicio || 'Redes / Conectividad'}</strong>
                                          </div>
                                          <div>
...
export default NetworkServiceReport;
